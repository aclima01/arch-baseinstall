...
echo root:password | chpasswd # <= lembrar de alterar senha de root
...
useradd -m alima
echo alima:password | chpasswd # <= lembrar de alterar senha de root
usermod -aG libvirt alima

echo "alima ALL=(ALL) ALL" >> /etc/sudoers.d/alima


printf "\e[1;32mFeito! Execute exit, umount -a e reboot.\e[0m"
